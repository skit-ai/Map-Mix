...
set_1 = pd.read_csv('/root/Langid/experiments/results/results-mixup_static_random-set-1.csv')
set_2 = pd.read_csv('/root/Langid/experiments/results/results-mixup_static_random-set-2.csv')
set_3 = pd.read_csv('/root/Langid/experiments/results/results-mixup_static_random-set-3.csv')

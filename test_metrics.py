...
set_1 = pd.read_csv('/root/Langid/results/csv/datamap-amb_easy-1.csv')
set_2 = pd.read_csv('/root/Langid/results/csv/datamap-amb_easy-32.csv')
set_3 = pd.read_csv('/root/Langid/results/csv/datamap-amb_easy-3.csv')

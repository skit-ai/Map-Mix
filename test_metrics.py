...
set_1 = pd.read_csv('/root/Langid/LangID-LRE17/results/results-random-set-1.csv')
set_2 = pd.read_csv('/root/Langid/LangID-LRE17/results/results-random-set-2.csv')
set_3 = pd.read_csv('/root/Langid/LangID-LRE17/results/results-random-set-3.csv')
